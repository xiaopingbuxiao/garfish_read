...
// src/garfish.ts
import { Loader as Loader3 } from "@garfish/loader";
...
import {
  TemplateManager as TemplateManager2,
  JavaScriptManager
} from "@garfish/loader";
...
async function processAppResources(loader, appInfo) {
  ...
  if (entryManager instanceof TemplateManager2) {
    isHtmlMode = true;
    ...
    fakeEntryManager = new TemplateManager2(mockTemplateCode, entryManager.url);
...
import { TemplateManager as TemplateManager3 } from "@garfish/loader";
  ...
  safeLoad({
    ...
    callback: (manager) => {
      const loadStaticResource = () => {
        if (manager instanceof TemplateManager3) {
